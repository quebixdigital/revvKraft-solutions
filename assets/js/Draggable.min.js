...
! function(e, t) {
    ...
    function w(e, t) {
        if (e.parentNode && (h || M(e))) {
            ...
            return t && (n ? (x = x || w(e), s.setAttribute("width", .01), s.setAttribute("height", .01), s.setAttribute("transform", "translate(" + i + "," + a + ")"), s.setAttribute("fill", "transparent"), x.appendChild(s)) : (g || (g = w(e), Object.assign(g.style, l)), Object.assign(s.style, l, {
                width: "0.1px",
                height: "0.1px",
                top: a + "px",
                left: i + "px"
    ...
    var h, f, i, a, g, x, m, y, v, t, b = "transform",
        T = b + "Origin",
        M = function _setDoc(e) {
            ...
            if (f = window, m = new ge, t) {
                i = (h = t).documentElement, a = t.body, (y = h.createElementNS("http://www.w3.org/2000/svg", "g")).style.transform = "none";
                var n = t.createElement("div"),
                    o = t.createElement("div"),
                    r = t && (t.body || t.firstElementChild);
                r && r.appendChild && (r.appendChild(n), n.appendChild(o), n.style.position = "static", n.style.transform = "translate3d(0,0,1px)", v = o.offsetParent !== n, r.removeChild(n))
            }
            return t
        },
        ...
        N = function _placeSiblings(e, t) {
            ...
            if (d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), n = s ? x : g, s) c ? (i = -(r = function _getCTM(e) {
                var t, n = e.getCTM();
                return n || (t = e.style[b], e.style[b] = "none", e.appendChild(y), n = y.getCTM(), e.removeChild(y), t ? e.style[b] = t : e.style.removeProperty(b.replace(/([A-Z])/g, "-$1").toLowerCase())), n || m.clone()
                ...
                return t
            }(o) : o.getItem(0).matrix : m).a * r.x + o.c * r.y, a = o.b * r.x + o.d * r.y) : (o = new ge, i = a = 0), t && "g" === e.tagName.toLowerCase() && (i = a = 0), (c || !e.getBoundingClientRect().width ? s : p).appendChild(n), n.setAttribute("transform", "matrix(" + o.a + "," + o.b + "," + o.c + "," + o.d + "," + (o.e + i) + "," + (o.f + a) + ")");
            else {
                if (i = a = 0, v)
    ...
    function getGlobalMatrix(e, t, n, o) {
        ...
        var r = E(e),
            ...
            d = a.parentNode,
            p = !o && k(e),
            u = new ge((s.left - l.left) / 100, (s.top - l.top) / 100, (c.left - l.left) / 100, (c.top - l.top) / 100, l.left + (p ? 0 : L()), l.top + (p ? 0 : C()));
    ...
    function $a(i, r) {
        ...
        B && !1 !== r.force3D ? (c = "translate3d(", d = "px,0px)") : O && (c = "translate(", d = "px)"), this.scrollTop = function(e, t) {
            ...
            (e = -e) < 0 ? (f = e - .5 | 0, e = 0) : w < e ? (f = e - w | 0, e = w) : f = 0, (f || o) && (this._skip || (u[O] = c + -f + "px," + -h + d), 0 <= f + v && (u.paddingRight = f + v + "px")), i.scrollLeft = 0 | e, x = i.scrollLeft
    ...
    function _a(e) {
        ...
        var n, o, r, i, a;
        xe ? (_e = xe.plugins.inertia, Ce = xe.core.context || function() {}, c = xe.utils.checkPrefix, O = c(O), Ye = c(Ye), Te = xe.utils.toArray, Le = xe.core.getStyleSaver, B = !!c("perspective")) : e && console.warn("Please gsap.registerPlugin(Draggable)")
    }
    var xe, me, ye, ve, l, s, we, be, c, Te, d, Me, Ee, De, Se, _e, Xe, Ae, Ce, Le, B, R, n, Pe = 0,
        O = "transform",
        Ye = "transformOrigin",
        ke = Array.isArray,
        Ne = 180 / Math.PI,
    ...
    function Draggable(h, p) {
        var e;
        e = Ve.call(this) || this, be || _a(1), h = Te(h)[0], e.styles = Le && Le(h, "transform,left,top"), _e = _e || xe.plugins.inertia, e.vars = p = ra(p || {}), e.target = h, e.x = e.y = e.rotation = 0, e.dragResistance = parseFloat(p.dragResistance) || 0, e.edgeResistance = isNaN(p.edgeResistance) ? 1 : parseFloat(p.edgeResistance) || 0, e.lockAxis = p.lockAxis, e.autoScroll = p.autoScroll || 0, e.lockedAxis = null, e.allowEventDefault = !!p.allowEventDefault, xe.getProperty(h, "x");
        ...
        function Bh(e, t) {
            var n, o, r = J.x,
                i = J.y;
            h._gsap || (se = xe.core.getCache(h)), se.uncache && xe.getProperty(h, "x"), W ? (J.x = parseFloat(se.x), J.y = parseFloat(se.y)) : Q ? J.x = J.rotation = da(parseFloat(se.rotation)) : f ? (J.y = f.top(), J.x = f.left()) : (J.y = parseFloat(h.style.top || (o = Na(h)) && o.top) || 0, J.x = parseFloat(h.style.left || (o || {}).left) || 0), (P || Y || k) && !t && (J.isDragging || J.isThrowing) && (k && (He.x = J.x, He.y = J.y, (n = k(He)).x !== J.x && (J.x = n.x, L = !0), n.y !== J.y && (J.y = n.y, L = !0)), P && (n = P(J.x)) !== J.x && (J.x = n, Q && (J.rotation = n), L = !0), Y && ((n = Y(J.y)) !== J.y && (J.y = n), L = !0)), L && Ah(!0), e || (J.deltaX = J.x - r, J.deltaY = J.y - i, Qa(J, "throwupdate", "onThrowUpdate"))
        }
        ...
        function Hh(e, t) {
            var n, o, r, i;
            e && _e ? (!0 === e && (n = p.snap || p.liveSnap || {}, o = ke(n) || Z(n), e = {
                resistance: (p.throwResistance || p.resistance || 1e3) / (Q ? 10 : 1)
            }, Q ? e.rotation = Ua(J, o ? n : n.rotation, D, S, 1, t) : (K && (e[G] = Ua(J, o ? n : n.points || n.x || n.left, D, S, f ? -1 : 1, t || "x" === J.lockedAxis)), U && (e[V] = Ua(J, o ? n : n.points || n.y || n.top, X, A, f ? -1 : 1, t || "y" === J.lockedAxis)), (n.points || ke(n) && $(n[0])) && (e.linkedProps = G + "," + V, e.radius = n.radius))), J.isThrowing = !0, i = isNaN(p.overshootTolerance) ? 1 === p.edgeResistance ? 0 : 1 - J.edgeResistance + .2 : p.overshootTolerance, e.duration || (e.duration = {
        ...
        function Ih(e) {
            var t, n = N;
            N = getGlobalMatrix(h.parentNode, !0), e && J.isPressed && !N.equals(n || new ge) && (t = n.inverse().apply({
                x: w,
                y: b
            }), N.apply(t, t), w = t.x, b = t.y), N.equals(r) && (N = null)
        }
        ...
        function Jh() {
            ...
            W && (se.x = Sg(G, "px") + "px", se.y = Sg(V, "px") + "px", se.renderTransform()), Ih(!1), Ge.x = J.pointerX - r, Ge.y = J.pointerY - i, N && N.apply(Ge, Ge), w = Ge.x, b = Ge.y, L && (he(J.pointerX, J.pointerY), Ah(!0)), d = getGlobalMatrix(h), f ? (Eh(), M = f.top(), T = f.left()) : (pe() ? (Bh(!0, !0), Eh()) : J.applyBounds(), Q ? (e = h.ownerSVGElement ? [se.xOrigin - h.getBBox().x, se.yOrigin - h.getBBox().y] : (Na(h)[Ye] || "0 0").split(" "), C = J.rotationOrigin = getGlobalMatrix(h).apply({
                x: parseFloat(e[0]) || 0,
                y: parseFloat(e[1]) || 0
            }), Bh(!0, !0), t = J.pointerX - C.x - r, n = C.y - J.pointerY + i, T = J.x, M = J.y = Math.atan2(n, t) * Ne) : (M = Sg(V, "px"), T = Sg(G, "px"))), E && o && (D < T ? T = D + (T - D) / o : T < S && (T = S - (S - T) / o), Q || (X < M ? M = X + (M - X) / o : M < A && (M = A - (A - M) / o))), J.startX = T = da(T), J.startY = M = da(M)
        }
        ...
        function Mh(e, t) {
            ...
            if (!u || J.isPressed || !e || !("mousedown" !== e.type && "pointerdown" !== e.type || t) && Re() - le < 30 && Ee[J.pointerEvent.type]) z && e && u && Ba(e);
                ...
                if (R = !(!v || K == U || !1 === J.vars.allowNativeTouchScrolling || J.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which)) && (K ? "y" : "x"), (z = !R && !J.allowEventDefault) && (Ba(e), za(me, "touchforcechange", Ba)), e.changedTouches ? (e = x = e.changedTouches[0], m = e.identifier) : e.pointerId ? m = e.pointerId : x = m = null, Pe++, function _addToRenderQueue(e) {
                ...
                Qa(J, "press", "onPress"), _e && _e.track(f || h, W ? "x,y" : Q ? "rotation" : "top,left")
            }
        }
        ...
        function Qh(e) {
            if (e && J.isDragging && !f) {
                ...
                (n || o) && (N ? (w -= n * N.a + o * N.c, b -= o * N.d + n * N.b) : (w -= n, b -= o), t._gsScrollX += n, t._gsScrollY += o, he(J.pointerX, J.pointerY))
            }
        }
        ...
        function Sh(e) {
            return N ? {
                x: e.x * N.a + e.y * N.c + N.e,
                y: e.x * N.b + e.y * N.d + N.f
            } : {
                x: e.x,
                y: e.y
            }
        }
        var u, f, w, b, T, M, E, g, s, D, S, X, A, x, m, C, L, t, P, Y, k, y, v, N, B, R, O, I, F, c, z, d, H, n = (p.type || "x,y").toLowerCase(),
        ...
        return (t = Draggable.get(h)) && t.kill(), e.startDrag = function(e, t) {
            ...
            if (Bh(!0), Eh(), E && !pe()) {
                if (n = J.x, o = J.y, D < n ? n = D : n < S && (n = S), X < o ? o = X : o < A && (o = A), (J.x !== n || J.y !== o) && (r = !0, J.x = J.endX = n, Q ? J.endRotation = n : J.y = J.endY = o, Ah(L = !0), J.autoScroll && !J.isDragging))
            ...
            if (t && J.isPressed) {
                if (Q) J.x = J.y = da(parseFloat(se.rotation));
                    ...
                    i.apply({
                        x: o.e - r.x,
                        y: o.f - r.y
                    }, r), J.x = da(J.x - (r.x - i.e)), J.y = da(J.y - (r.y - i.f))
                }
                Ah(!0), Jh()
            }
            var a = J.x,
                l = J.y;
            return Ih(!t), e ? J.applyBounds() : (L && n && Ah(!0), Bh(!0)), t && (he(J.pointerX, J.pointerY), L && Ah(!0)), J.isPressed && !t && (K && .01 < Math.abs(a - J.x) || U && .01 < Math.abs(l - J.y) && !Q) && Jh(), J.autoScroll && (La(h.parentNode, J.isDragging), te = J.isDragging, Ah(!0), Ia(h, Qh), Ha(h, Qh)), J
        }, e.enable = function(e) {
            var t, n, o, r = {
                lazy: !0
            };
            ...
            if ("soft" !== e) {
                ...
                Wa(q, !0), v && (Aa(v, "touchcancel", fe), Aa(v, "touchend", fe), Aa(v, "touchmove", ue)), Aa(de, "mouseup", fe), Aa(de, "mousemove", ue)
            }
            return Ia(h, Qh), u = !1, _e && "soft" !== e && (_e.untrack(f || h, W ? "x,y" : Q ? "rotation" : "top,left"), J.tween && J.tween.kill()), f && f.disable(), xa(Ah), J.isDragging = J.isPressed = y = !1, n && Qa(J, "dragend", "onDragEnd"), J
        ...
        }, p)), h.style.overflowY = U && !Me ? "auto" : "hidden", h.style.overflowX = K && !Me ? "auto" : "hidden", h = f.content), Q ? o.rotation = 1 : (K && (o[G] = 1), U && (o[V] = 1)), se.force3D = !("force3D" in p) || p.force3D, Ce(_assertThisInitialized(e)), e.enable(), e
        ...
        isDragging: !1,
        isPressed: !1
    }), F.zIndex = 1e3, F.version = "3.14.1", Y() && xe.registerPlugin(F), e.Draggable = F, e.default = F;
