(function($) {
    ...
    function text_color_invert() {
        const split = new SplitText(".text_color_invert", {
            type: "lines"
        });
        ...
        gsap.utils.toArray(".fade_anim").forEach((item) => {
            let tp_fade_offset = item.getAttribute("data-fade-offset") || 40,
                ...
                tp_anim_setting = {
                    ...
                    x: tp_fade_direction == "left" ?
                        -tp_fade_offset :
                        tp_fade_direction == "right" ?
                        tp_fade_offset :
                        0,
                    y: tp_fade_direction == "top" ?
                        -tp_fade_offset :
